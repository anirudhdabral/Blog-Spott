...
Context API data can be accessed by child components (AddBlog.js, EditBlog.js) and super child components (HomeCard.js), both of which are used in this web-app.
1. App.js -> AddBlog.js
2. App.js -> EditBlog.js
3. App.js -> Home.js -> HomeCard.js
